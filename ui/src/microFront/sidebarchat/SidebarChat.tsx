...
export const SidebarChat: React.FC = () => (
    <div className='sidebarchat-column'>
        ...
        <div className='sidebarchat-footer'>
            <textarea className='sidebarchat-textarea' placeholder='Type your message...'></textarea>
