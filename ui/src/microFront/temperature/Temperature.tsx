      ...
      <div className="cardm">
        ...
        <div className="card2">
          ...
          KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg==" y={0} x={0} height={30} width={30} id="image0" />
            ...
            <div className="air">
              <div className="airtext">Wind<br />15 Km/h</div>
          ...
          OFQwNToxNToyNiswMDowMIjQlfwAAAAASUVORK5CYII=" />
              ...
              <div className="realfeeltext">SNT<br />32 °C</div>
            </div>
          ...
          Ut8AAAAASUVORK5CYII=" />
              ...
              <div className="pressuretext">PRS<br />1013 mbar</div>
            </div>
            <div className="card3">
              Healthy
            </div>
...
const StyledWrapper = styled.div`
  ...
  .card:hover {
    background-color: #3a3a3a;  /* updated */
    cursor: pointer;
  }
  ...
  .main {
    ...
    top: -3em;
    left: 3.5em;
    color: #ffffff;             /* unchanged (matches target) */
  }
  ...
  .card3 {
    ...
    background: #2ecc71;        /* updated */
    color: #1e1e1e;             /* updated */
    transition: 0.4s ease-in-out;
  }
`;
